        ...
        <table class="table text-nowrap align-middle mb-0">
          ...
          <tbody>
            <tr v-for="purchase in purchases" :key="purchase.id">
              ...
              <td class="shadow-none lh-1 fs-14 fw-normal text-paragraph">
                {{ currencySymbol }}{{ purchase.totalAmount ?? "0.00" }}
              </td>
              <!-- <td class="shadow-none lh-1 fs-14 fw-normal text-paragraph">
                {{ currencySymbol }}{{ purchase.paidAmount ?? "0.00" }}
              </td>
              <td class="shadow-none lh-1 fs-14 fw-normal text-paragraph">
                {{ currencySymbol }}{{ purchase.dueAmount ?? "0.00" }}
              </td>
              <td class="shadow-none lh-1 fs-14 fw-normal text-paragraph">
                <span class="badge badge-success fs-14 fw-normal">
            ...
            <tr v-if="!purchaseStore.loading && purchases.length === 0">
              <td colspan="10" class="text-center text-muted py-3">No purchases found.</td>
            </tr>
          </tbody>
        </table>
