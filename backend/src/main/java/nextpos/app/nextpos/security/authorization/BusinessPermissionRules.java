...
public final class BusinessPermissionRules {
    ...
    private static final List<Rule> RULES = List.of(
            ...
            rule("/api/v1/products/bulk-delete", "PRODUCT_DELETE", "PRODUCT_DELETE", "PRODUCT_DELETE", "PRODUCT_DELETE"),
            rule("/api/v1/products/bulk-update-status", "PRODUCT_EDIT", "PRODUCT_EDIT", "PRODUCT_EDIT", "PRODUCT_EDIT"),
            ...
            rule("/api/v1/import-export/export", "PRODUCT_LIST", "PRODUCT_LIST", "PRODUCT_LIST", "PRODUCT_LIST"),
            rule("/api/v1/import-export/import", "PRODUCT_CREATE", "PRODUCT_CREATE", "PRODUCT_CREATE", "PRODUCT_CREATE"),
