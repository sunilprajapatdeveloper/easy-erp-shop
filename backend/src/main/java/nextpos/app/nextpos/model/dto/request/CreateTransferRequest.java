...
public class CreateTransferRequest {
    @NotNull private final Long fromWarehouse;
    @NotNull private final Long toWarehouse;
    @NotNull private final LocalDate date;
    @NotNull @Size(min = 1) @Valid private final List<TransferProductRequest> products;
    ...
    @NotNull private final ShipmentStatus status; private final String note;

    @Getter
    @AllArgsConstructor
    @Builder
    public static class TransferProductRequest {
        ...
        @NotNull @Min(1) private final Integer transferredQty;
